<?php
    ...
    if (isset($_POST['email'])) {
        ...
        if ($result->num_rows > 0){ // 是已註冊的 Email
            // 產生Token
            $token = "qwertyuioplkjhgfdsazxcvbnmQWERTYUIOPLKJHGFDSAZXCVBNM1234567890!@#$^*_+";
            ...
            // require_once ("vendor/phpmailer/phpmailer/src/PHPMailer/PHPMailer.php");
            // require_once ("vendor/phpmailer/phpmailer/src/PHPMailer/Exception.php");
            // require_once ("vendor/phpmailer/phpmailer/src/PHPMailer/SMTP.php");
            ...
            /* 寄信者的SMTP帳號 */
            $mail->Username =  "s111002628@g.ksu.edu.tw"; // $cms_gmailname;
            /* 寄信者的SMTP密碼 */
            $mail->Password = 'wmcidqnreciyjoim'; //$cms_gmailpass; // 二段式驗證密碼（16字)

            /* 寄信者電子郵件 */
            $mail->From = "s111002628@g.ksu.edu.tw";
            /* 寄信者名稱 */
            $mail->FromName = "Yi-Fei Chang";
            /* 收件者的電子郵件 */
            $mail->addAddress($email, "客倌");
            /* 回信的電子郵件 */
            $mail->addReplyTo("s111002628@g.ksu.edu.tw", "Yi-Fei Chang");
            /* 信件主旨 */
            $mail->Subject = "重置密碼";
            /* 設定斷行字數 */
            // $mail->WordWrap = 50;
            ...
            'http://a110e109.ksu.edu.tw/php_practice/Assignments-06/reset_password.php?email=$email&token=$token'
            a110e109敬上");
